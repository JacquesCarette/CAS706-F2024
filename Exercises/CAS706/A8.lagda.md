This is a copy of `CAS706.part2.More`. You will add more features, namely:

Exercise: New language features (15 points)
  (i.e. types, type judgements, value rules, reduction rules;
    make sure progress and eval still work)
- Add the empty type
- Add sum types
- Add the unit type
...
Include examples of computations for each new feature, i.e. tests

Put the new code you add between `--begin` and `--end` markers please!

```agda
module CAS706.A8 where
...
Bonus exercise (this is harder). (5 points)
```agda
double-subst :
